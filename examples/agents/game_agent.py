"""
Game agent for ATP Game-Theoretic testing (Anthropic Claude).

Receives a game situation description, chooses an action via LLM,
and returns the decision in ATP Protocol format.
...
async def handle_request(request: ATPRequest) -> ATPResponse:
    """Handle ATP request: choose an action via Claude."""
    ...
    try:
        ...
        if parsed and "action" in parsed:
            ...
            # Fallback: try to extract a keyword
